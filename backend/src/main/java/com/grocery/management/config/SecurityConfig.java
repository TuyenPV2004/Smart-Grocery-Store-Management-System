...
public class SecurityConfig {
    ...
    private final Converter<Jwt, AbstractAuthenticationToken> keycloakUserAuthenticationConverter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2ResourceServer(oauth2 -> oauth2.jwt(jwt ->
                        jwt.jwtAuthenticationConverter(keycloakUserAuthenticationConverter)));
