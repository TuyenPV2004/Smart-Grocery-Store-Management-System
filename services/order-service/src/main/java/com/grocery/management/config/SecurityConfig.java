    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/reviews/products/*/eligibility").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/reviews/products/*").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/reviews").hasAnyAuthority("ADMIN", "STAFF")
                        ...
                        .requestMatchers("/api/reviews/*/reply").hasAnyAuthority("ADMIN", "STAFF")
