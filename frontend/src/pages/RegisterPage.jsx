...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F0FDF4] p-4 font-poppins antialiased text-slate-600">
      <div className="w-full max-w-[550px] bg-white rounded-[2.5rem] shadow-2xl shadow-emerald-900/5 overflow-hidden border border-emerald-50 transition-all">
